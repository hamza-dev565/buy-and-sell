...
const Router = ({ history, routerAnimation, statee }) => {
  ...
  const routes = [
    ...
    },
    {
      ...
      Component: lazy(() => import('pages/createCategory')),
      exact: true,
    },
    {
      path: '/create/product',
    ...
    },
    {
      ...
      Component:
        userData.role === 'admin'
          ? lazy(() => import('pages/adminCategory'))
    ...
    },
    {
      ...
      Component:
        userData.role === 'admin'
          ? lazy(() => import('pages/purchaseHistory/admin-purchase-history'))
    ...
    {
      path: '/editprofile',
      Component: lazy(() => import('pages/apps/editProfile')),
      exact: true,
    },
    {
      path: '/apps/mail',
    ...
    {
      path: '/settings',
      Component: lazy(() => import('pages/category2')),
      exact: true,
    },
    {
      path: '/ui-kits/antd',
