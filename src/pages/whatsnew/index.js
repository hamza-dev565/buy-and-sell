...
import faq1 from './images/new.png'
...
const CategoryPage = ({ category, product, dispatch, intl }) => {
  ...
  const items = [
    {
      id: 1,
      name: intl.formatMessage({ id: 'new.live' }),
      ans: intl.formatMessage({ id: 'new.nowOpen' }),
      image: faq1,
    },
    {
      id: 2,
      name: intl.formatMessage({ id: 'new.introducing' }),
      ans: intl.formatMessage({ id: 'new.nowYouCan' }),
      image: faq1,
    },
    {
      id: 3,
      name: intl.formatMessage({ id: 'new.newYear' }),
      ans: intl.formatMessage({ id: 'new.liveData' }),
      image: faq1,
    },
    {
      id: 4,
      name: intl.formatMessage({ id: 'new.commingSoon' }),
      ans: intl.formatMessage({ id: 'new.commingSoon' }),
      image: faq1,
    },
    {
      id: 5,
      name: intl.formatMessage({ id: 'new.development' }),
      ans: intl.formatMessage({ id: 'new.commingSoon' }),
      image: faq1,
    },
  ]
